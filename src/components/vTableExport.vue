...
const processData = (data) => {
  return data.map((item) => {
    ...
    // fields
    content +=
      `<tr>\n<th scope='rowgroup' colspan='${keysWithoutFields.length}'>Fields</th>\n</tr>\n`
    const fields = item["fields"].map((value, index) => {
      let row = "<tr>\n"
...
<template>
  <highlightjs :autodetect="false" language="html" :code="processedData" />
